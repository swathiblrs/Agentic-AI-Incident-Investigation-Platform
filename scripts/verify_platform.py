...
def main() -> None:
    ...
    checks = {
        ...
        "security_a2a_exchange": any("A2A exchange" in item for item in security_report.timeline),
        "security_a2a_peer_message": any("soc_agent -> it_agent" in item for item in security_report.timeline),
        "generic_mcp_timeline": any("MCP tool" in item for item in incident_report.timeline),
        "generic_a2a_exchange": any("A2A exchange" in item for item in incident_report.timeline),
        "generic_a2a_peer_message": any("sre_agent -> cloud_agent" in item for item in incident_report.timeline),
    ...
    output = {
        ...
        "metrics": {
            ...
            **a2a_metrics,
            ...
            "a2a_messages_per_investigation": a2a_metrics["a2a_messages_per_investigation"],
